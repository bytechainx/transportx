//! tokio-tungstenite 默认 WebSocket 驱动。
//!
//! 公开类型 [`TungsteniteWsConnector`] 经 crate 根 `pub use` 导出，路径与拆分前一致；
//! 帧级边界 trait 见 crate 根的 [`crate::WsConnector`] / [`crate::WsConnection`]。
...
use crate::{
    TransportError, WsConnection, WsConnector, DEFAULT_MAX_WS_FRAME_BYTES,
